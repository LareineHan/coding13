  ...
  return (
    <div>
        <div className="information-card">
            <section className="information-card-content">
                ...
                <div>
                    <a href="#"><button className="information-card-content-btn">Find Out More</button></a>
                </div>
            </section>
        ...
        <div className="information-card">
            ...
            <section className="information-card-content">
                ...
                <div>
                    <a href="#"><button className="information-card-content-btn">Parcourir Les Articles</button></a>
                </div>
            </section>
        </div>
        ...
        <div className="information-card">
            <section className="information-card-content">
                ...
                <div>
                    <a href="#"><button className="information-card-content-btn">List Your Property</button></a>
                </div>
            </section>
